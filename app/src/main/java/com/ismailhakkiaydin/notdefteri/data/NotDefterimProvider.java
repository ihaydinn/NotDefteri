...
public class NotDefterimProvider extends ContentProvider {
    ...
    static {
        matcher.addURI(NotDefterimContract.CONTENT_AUTHORITY, NotDefterimContract.PATH_NOTLAR, URICODE_NOTLAR);
        matcher.addURI(NotDefterimContract.CONTENT_AUTHORITY, NotDefterimContract.PATH_KATEGORILER, URICODE_KATEGORILER);
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (matcher.match(uri)){
            ...
            case URICODE_KATEGORILER:
                cursor=db.query(NotDefterimContract.KategoriEntry.TABLE_NAME, projection,selection,selectionArgs,null,null,sortOrder);
                break;
            default:
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        switch (matcher.match(uri)){
            ...
            case URICODE_NOTLAR:
                return kayitEkle(uri, values, NotDefterimContract.NotlarEntry.TABLE_NAME);

            case URICODE_KATEGORILER:
                return kayitEkle(uri, values, NotDefterimContract.KategoriEntry.TABLE_NAME);
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (matcher.match(uri)){
            ...
            case URICODE_NOTLAR:
                return kayitSil(uri, selection, selectionArgs,NotDefterimContract.NotlarEntry.TABLE_NAME);

            case URICODE_KATEGORILER:
                return kayitSil(uri, selection, selectionArgs,NotDefterimContract.KategoriEntry.TABLE_NAME);
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (matcher.match(uri)){
            ...
            case URICODE_NOTLAR:
                return kayitGuncelle(uri,values,selection,selectionArgs, NotDefterimContract.NotlarEntry.TABLE_NAME);

            case URICODE_KATEGORILER:
                return kayitGuncelle(uri,values,selection,selectionArgs, NotDefterimContract.KategoriEntry.TABLE_NAME);
