...
import com.ismailhakkiaydin.notdefteri.data.NotDefterimContract;
...
public class NotActivity extends AppCompatActivity {
    ...
    String yeniMi;
    Calendar takvim;
    NotDefterimQueryHandler handler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler=new NotDefterimQueryHandler(this.getContentResolver());
        ...
        String[] projection={NotDefterimContract.KategoriEntry._ID, NotDefterimContract.KategoriEntry.COLUMN_KATEGORI};
        kategoriCursor=getContentResolver().query(NotDefterimContract.KategoriEntry.CONTENT_URI,projection, null, null,null);
        ...
        yeniMi=gelenNot.getStringExtra(NotDefterimContract.NotlarEntry._ID);
